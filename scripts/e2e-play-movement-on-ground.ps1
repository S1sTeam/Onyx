...
$TeleportConfirmPacketId = 0x6E
$OnGroundPacketId = 0x72
$ExpectedTeleportId = 91
$ExpectedUsername = "MoveGroundProbe"
$SpawnX = 2.5
$SpawnY = 70.0
$SpawnZ = -3.0
$FinalOnGround = $false
...
try {
    ...
    [void](Read-Exact $packet.Stream 4)
    ...
    $packetBody.WriteByte([byte]([int]$FinalOnGround))
    ...
    if ($disconnectReason -notmatch 'movement-packets=1') {
    
    throw "Server did not record movement packet: $disconnectReason"
    }
    ...
    Write-Host "[ONYX] E2E_PLAY_MOVEMENT_ON_GROUND_OK"
