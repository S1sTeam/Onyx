param(
    ...
    [int]$ProxyPort = 30565,
    [int]$BackendPort = 30566 )
Set-StrictMode -Version Latest
$ErrorActionPreference = "Stop"
$Protocol = 47
$DisconnectPacketId = 0x40
$KeepAliveClientboundId = 0x00
$KeepAliveServerboundId = 0x00
...
try {
    ...
    $token = Read-VarInt $packet.Stream
    ...
    Write-Host "[ONYX] E2E_PLAY_KEEPALIVE_VANILLA_OK"
