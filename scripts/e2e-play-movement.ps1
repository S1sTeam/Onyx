...
$PositionPacketId = 0x6F
$ExpectedTeleportId = 42
$ExpectedUsername = "MovementProbe"
$SpawnX = 2.5
$SpawnY = 70.0
$SpawnZ = -3.0
$MoveX = 3.25
...
try {
    ...
    $stream.Write($movePacket, 0, $movePacket.Length)
    ...
    throw "Movement packet was not sent"
    }
    ...
    Write-Host "[ONYX] E2E_PLAY_MOVEMENT_OK"
